...
const Contact = () => {
 ...
 <div className='flex flex-col justify-center items-start gap-6'>
  <p className='font-semibold-lg text-gray-600'>Our OFFICE</p>
...
Email: greatstackdev@gmail.com</p>
  ...
  <button className='border textblack px-8 py-4 text-sm hover:bg-black hover:text-white transition-all duration-500'>Explore Jobs</button>
 </div>
   </div>
    </div>
  )
